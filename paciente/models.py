...
class Preferencia(models.Model):
    ...
    experiencia = models.TextField(
        max_length=200, null=True, blank=True, verbose_name='')
    nombre_pareja = models.CharField(
        max_length=25, blank=True, null=True, verbose_name="")
    ...
    nombre_empresa = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="")
    gustos = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="")
    fecha_empresa = models.DateField(blank=True, null=True, verbose_name="")
    deportes = models.CharField(
        max_length=150, blank=True, null=True, verbose_name="")
    pelicula_serie = models.CharField(
        max_length=150, blank=True, null=True, verbose_name="")
    musica = models.CharField(
        max_length=150, blank=True, null=True, verbose_name="")
